...
from backend.app.models.models import Doctor, Patient, MedicalRecord, OCRRecord, Embedding, Visit, Prescription, Conversation, Timeline, AuditLog, ApiKey, PatientRegistrationDraft, ProfileDiscrepancy
